...
import { CloudRain, ArrowRight, Check, X } from "lucide-react";
...
const QUESTION = {
  ...
  questionNumber: QUIZ_SEQUENCE[1], // "Pergunta 7 de 30"
  totalQuestions: 30,
  label: "Direção Defensiva",
  errorRate: "61%",
  text: "Durante uma forte chuva, você percebe que o seu veículo começou a oscilar e flutuar sobre uma camada de água na pista, perdendo o contato dos pneus com o solo (aquaplanagem). Qual deve ser seu procedimento imediato?",
  options: [
    {
      id: "a",
      text: "Pisar firmemente no pedal do freio para reduzir a velocidade o mais rápido possível.",
    },
    {
      id: "b",
      text: "Girar o volante em movimentos rápidos de um lado para o outro para forçar a aderência dos pneus ao asfalto.",
    },
    {
      id: "c",
      text: "Tirar o pé do acelerador suavemente, segurar o volante com firmeza em linha reta e não frear até recuperar a tração.",
    },
    {
      id: "d",
      text: "Colocar o câmbio em ponto morto e pisar levemente no acelerador para deslizar com segurança até o carro parar.",
    },
  ],
  correctId: "c",
};
...
export default function StepPergunta02() {
          ...
          {!confirmed ? (
            ...
            >
              ...
              >
                ...
                >
                  {isCorrect ? "✓ Acertou, mas a maioria erra." : "✗ Seu instinto te traiu."}
                </p>
                <p className="text-xs leading-relaxed text-[oklch(0.4_0.01_250)]">
                  {isCorrect
                    ? "Soltar o acelerador e segurar o volante firme é o procedimento correto. Mas na prova real, a maioria marca \"frear\" por instinto. É exatamente esse tipo de questão que reprova."
                    : "Frear durante a aquaplanagem trava as rodas e causa perda total de controle. O correto é soltar o acelerador suavemente, segurar o volante firme e esperar a tração voltar. O instinto natural aqui é o inimigo."}
                </p>
              </div>

              <Link href="/step-04-pergunta-03" className="w-full py-4 rounded-2xl bg-[oklch(0.25_0.01_250)] text-white text-sm font-semibold flex items-center justify-center gap-2 active:scale-[0.98] transition-transform duration-150 shadow-[0_4px_16px_oklch(0.15_0.01_250/20%)]">
                Vamos mais uma?
                <ArrowRight size={16} />
              </Link>
            </motion.div>
