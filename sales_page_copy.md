...
- **A internet mistura ajuda com promessa suspeita:** App aleatório, vídeo fora de ordem, promessa milagrosa e golpe disputam sua atenção.
...
- **Plano simples pelo celular:** Sequência de estudo para parar de pular de vídeo em vídeo sem saber o próximo passo.
- **Treino sem promessa enganosa:** Nós não prometemos questão vazada, banco oficial ou aprovação garantida. Prometemos direção e clareza.
- **Preparação para chegar mais calmo:** Você treina antes, erra antes e entende antes. O dia da prova fica menos improvisado.

---

## 4. Autoridade (InstructorSection)
**Eyebrow:** Quem guia o plano
**H2:** Um professor para organizar o que a internet deixa solto.
**Body:** Anderson organizou o treinamento para quem não quer decorar conteúdo solto. A ideia é simples: entender o que a prova cobra, treinar no formato certo e chegar com mais calma.

**Bullets da Autoridade:**
- Professor, especialista em gestão, mobilidade e segurança no trânsito
- Aulas diretas para revisão e treino de prova teórica
- Preparação complementar, sem promessa absoluta
...
- 4.7/5 avaliação do instrutor
- 2 cursos base do Anderson
- 30 questões no formato da prova
...
- **As questões são iguais às do Detran?** Nós não prometemos questão vazada, banco oficial ou cópia da prova. O treinamento usa temas, formato e raciocínio compatíveis com o que costuma ser cobrado na prova teórica.
- **Isso substitui a autoescola, app oficial ou etapa do Detran?** Não. É uma preparação complementar para estudar melhor. Você continua responsável por cumprir as regras, agendamentos, exames e exigências do seu estado.
- **E se eu tiver pouco tempo?** A página foi pensada para celular e estudo em blocos. O foco é revisar os pontos certos, não criar uma rotina impossível.
- **O produto garante aprovação?** Não existe aprovação garantida. A promessa correta é clareza: saber o que revisar, treinar melhor e chegar mais preparado para a primeira tentativa.

**Chamada Final (Fechamento):**
...
**CTA Final:** Quero estudar com direção
